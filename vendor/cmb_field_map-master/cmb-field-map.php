...
class PW_CMB2_Field_Google_Maps {
	...
	public function render_pw_map( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		// Get the Google API key from the setting parameters.
		$api_key = get_option( 'ascsoftw_sl_google_apikey' );
		...
		echo '<a href="#" onclick="return false;" class="pw-update-address" style="display:none;">' . __( 'Update Fields', 'ascsoftw-store-locator' ) . '</a>';
